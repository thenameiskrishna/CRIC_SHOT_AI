...
import heroVid from '../assets/video/bannervideo.mp4';
import Vid from '../assets/video/bannervideo_21_compressed.mp4';
...
const Banner = () => {
  ...
  return (
    <section className='w-full h-[95vh] mt-20  top-[90px] py-2e flex  justify-center items-center text-center border-b-2 dark:border-slate-800 border-[#00df9a]'>
      <video
      ...
      <div className="container mx-auto text-black   dark:text-white bg-[#1E1E1E] p-20 lg:w-1/2 backdrop-filter backdrop-blur-lg bg-opacity-30">
        <p className="lg:text-4xl font-bold mb-2 py-2 " data-aos="zoom-in">Discover the Innovation</p>
        <div>
          <p className="mb-6 lg:p-5  dark:text-white text-2xl font-bold md:pl-4 pl-2" data-aos="zoom-in">
            Check the shot
          </p>
        </div>
