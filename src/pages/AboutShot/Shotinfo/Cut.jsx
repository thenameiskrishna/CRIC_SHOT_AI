...
import Gif from '../../../assets/Gif/square.gif';
import Gif2 from '../../../assets/Gif/upper.gif';
import Gif3 from '../../../assets/Gif/late.gif';
  ...
  return (
    <div className="dark:bg-[#1C2222] bg-gray-100 min-h-screen mt-20">
      <div className="container mx-auto px-4 lg:px-8 py-8">
        <h1 className="text-3xl font-bold mb-4 text-center text-[#286753]" data-aos="zoom-in">Cuts</h1>
        <p className="py-4 dark:text-gray-300 mb-4 md:text-lg text-center" data-aos="zoom-in">
