...
import Gif from '../../../assets/Gif/Innova/ramp.webp';
import Gif2 from '../../../assets/Gif/Innova/switchhit.gif';
import Gif3 from '../../../assets/Gif/Innova/dilscoop.webp';
import Gif4 from '../../../assets/Gif/Innova/paddlescoop.gif';
import Gif5 from '../../../assets/Gif/Innova/reversescoop.gif';
import Gif6 from '../../../assets/Gif/Innova/helicopter.gif';
...
const Inno = () =>  {
  ...
  return (
    ...
    <div className="dark:bg-[#1C2222] bg-gray-100 min-h-screen mt-20">
