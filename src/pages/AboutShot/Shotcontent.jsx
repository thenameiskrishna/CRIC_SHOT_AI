...
import Gifshot from '../../assets/Gif/playshot.gif'
import Gifshot1 from '../../assets/Gif/playshotdark.gif'
...
const Shotcontent = () => {
  ...
  return (
    <div className="flex min-h-screen mt-20 items-center justify-center m-auto bg-gray-100 dark:bg-[#1C2222]">
